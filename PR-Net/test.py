...
parser.add_argument('--tvsearch', default=False, help='whether thermal to visible search on RegDB') # RegDB
...
net = pr_net(n_class, dataset, arch=args.arch)
...
if dataset == 'llcm':
    ...
    for trial in range(10):
        test_trial = trial +1
        # model_path = checkpoint_path + args.resume0
